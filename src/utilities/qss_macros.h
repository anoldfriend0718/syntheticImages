...
#ifndef included_qss_macros_h
#define included_qss_macros_h
...
{                                                                       \
    ...
    for(idx = 0; idx < grid->num_gridpts; idx++)                             \
  {                                                                        \
        bin_vel[idx] = ((connectivity[idx] == main_comp_val)               \
        || (connectivity[idx] == 0)) ? 1 : 0;                               \
    }                                                                       \
}
...
{                                                                       \
    ...
    for(idx = 0; idx < grid->num_gridpts; idx++)                             \
    {                                                                        \
        mask[idx] = ((bin_disconn[idx] == 1) && (phi[idx] < 0)) ? -phi[idx] : mask[idx];     \
    }                                                                       \
}
...
{                                                                          \
  ...
  for(idx = 0; idx < grid->num_gridpts; idx++)                             \
  {                                                                        \
    data_final[idx] = data_1[idx] && data_2[idx];       \
  }                                                                        \
}
