 ...
 *      ----------                   ------------
 */
#define QSS3D_COMPUTE_REINITIALIZATION_EQN_RHS                              \
                                     qss3dcomputereinitializationeqnrhs_
 ...
 *
 */
void QSS3D_COMPUTE_REINITIALIZATION_EQN_RHS(
 ...
 *  Return value:             none
 */
void QSS3D_COMPUTE_ORTHOGONALIZATION_EQN_RHS(
